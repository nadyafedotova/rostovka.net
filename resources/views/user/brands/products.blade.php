...
@section('category')
    <meta name="brand_id" content="{{$brand -> id}}">
    <div class="categoryPage" dataID="{{$brand -> id}}">
                ...
                <div class="row">
                    <div class="col-md-10 push-md-2 product--block">
                        ...
                        <div class="list-page-title">
                            <div class="row" style="padding: 15px 0px; margin: 0;"> 
                                @if($brand -> photo) 
                                    <div class="col-md-3" style="text-align: center;"> 
                                        <img src="{{url('/images/brands/'. $brand -> photo)}}" url="" style="height: 150px; width: auto;">
                                    </div>    
                                @endif
                                <div class="@if($brand -> photo) col-md-9 @else col-md-12 @endif">
                                    <h1 class="" style="margin-bottom: 5px;font-size: 28px;line-height: 1.3;">{{ $brand -> name }}</h1><hr>        
                                    @if($brand -> description)
                                        <div class="description" style="padding-top: 10px;">{!! $brand -> description !!}</div>
                                    @endif
                                </div>
                            </div>
                        </div>
