...
@section('category')
    ...
    <div class="categoryPage" data-link="{{$category -> link}}" dataID="{{$category -> id}}">
                ...
                <div class="row">
                    <div class="col-md-10 push-md-2 product--block">
                        ...
                        <div class="list-page-title">
                            <h1 class="" style="font-size: 28px;line-height: 1.3;">@if ($category -> name == 'Детское')Детская@elseif($category -> name == 'Мужское')Мужская@elseif($category -> name == 'Женское')Женская@endif @if ($category -> name != 'Перчатки')обувь оптом@elseПерчатки@endif</h1>
                        </div>
                        <!-- End Title -->
                        ...
                        @if($category -> text)
                            <div class="description" style="padding-top: 10px;">{!! $category -> text !!}</div>
                        @endif
                    </div>
...
<span class="col-md-6 pull-left boxCount sp3" style="/*margin-top:-17px;*/"><b>${box}</b> - ${names.box}</span>
<span class="col-md-6 pull-right minCount sp4" data-set="minimum" style="/*margin-top:-17px;*/"><b>${rostovka}</b> - ${names.rostovka}</span>
</span>
</div>
