...
<div class="blocks">
    <div class="bl1">
        ...
        <table cellpadding ="4" cellspacing="0" >
            ...
            <tr>
                <td class="text" align="right" colspan="5">ФИО:</td>
                <td class="text" align="right" colspan="2">{{$order -> first_name}} {{$order -> last_name}}</td>
            </tr>
            <tr>
                <td class="text" align="right" colspan="5">Телефон:</td>
                <td class="text" align="right" colspan="2">{{$order -> phone}}</td>
            </tr>
            <tr>
                <td class="text" align="right" colspan="5">Адрес доставки:</td>
                <td class="text" align="right" colspan="2">{{$order -> address}}</td>
            </tr>
            <tr>
                <td class="text" align="right" colspan="5">Номер отделения компании перевозчика:</td>
                <td class="text" align="right" colspan="2">{{$order -> info}}</td>
            </tr>
            <tr>
                <td class="text" align="right" colspan="5">Способы доставки:</td>
            ...
            <tr>
                <td class="text" align="right" colspan="5">Способы оплаты:</td>
                <td class="text" align="right" colspan="2">
            ...
            <tr>
                <td class="text" align="right" colspan="5">Коментарий:</td>
                <td class="text" align="right" colspan="2">
                    {{ $order -> komment }} 
                </td>
            </tr>
