!function (e) {
    ...
    var i = e(window),
        a = e(document);
    e(function () {
        e(".navigation-menu > ul > li:has( > ul)").addClass("menu-dropdown-icon"),
        e(".navigation-menu > ul > li.menu-dropdown-icon").append(
            '<div class="dropworn-arrow"></div>'
        ),
        e(".navigation-menu > ul > li > ul:not(:has(ul))").addClass("normal-sub"),
        e(".navigation-menu > ul").before(
            '<a href="#" class="menu-mobile"><i class="fa fa-bars" aria-hidden="true"></i><' +
            '/a>'
        );
        ...
        a.on("mouseenter mouseleave", function (a) {
            i.width() > parseInt(979) && (
                e(this).children(".js-nav-dropdown").stop(!0, !1).fadeToggle(150),
                e(this).children(".dropworn-arrow").stop(!0, !1).fadeToggle(150),
                a.preventDefault()
            )
        }),
        a.on("click", function () {
            i.width() <= parseInt(979) && (
                e(this).children(".js-nav-dropdown").fadeToggle(150),
                e(this).children(".dropworn-arrow").hide()
            )
        }),
        t.on("click", function (i) {
            e(".mobileNav ").toggleClass("display"),
            i.preventDefault()
        })
    }),
    // e(function () {
    ...
    i.bind("DOMContentLoaded load resize", function () {
        ...
        i.innerWidth() <= parseInt(979)
            ? (
                e("#header-sticky").addClass("no-stick"),
                e(".header").css("height", "auto")
            )
            : (e("#header-sticky").removeClass("no-stick"), e(".header").css("height", a))
    }),
    e(function () {
        ...
        if (
            s.on("click", function () {
                ...
                t.toggleClass("sidebar-open"),
                n.toggleClass("sidebar_overlay_active")
            }),
            o.on("click", function () {
                s.removeClass("active"),
                t.removeClass("sidebar-open"),
                n.removeClass("sidebar_overlay_active")
            }),
            ...
            e(function () {
                ...
                i.on("click", function (i) {
                    e(".search-overlay-menu").addClass("open"),
                    e('.search-overlay-menu > form > input[type="search"]').focus()
                }),
                a.on("click keyup", function (i) {
                    i.target != this && "search-overlay-close" != i.target.className && 27 != i.keyCode || e(
                        this
                    ).removeClass("open")
                })
            }),
            e('a[data-toggle="tab"]').on("shown.bs.tab", function (i) {
                e(e(i.target).attr("href"))
                    .find(".owl-carousel")
                    .owlCarousel("inval§idate", "width")
                    .owlCarousel("update")
            }),
            e(".js_tooltip").tipr(),
            e(".slide-bg-image, .bg-image").each(function (i) {
                e(this).attr("data-background-img") && e(this).css(
                    "background-image",
                    "url(" + e(this).data("background-img") + ")"
                ),
                e(this).attr("data-bg-position-x") && e(this).css(
                    "background-position",
                    e(this).data("bg-position-x")
                )
            }),
            i.width() > parseInt(979)
        ) {
            var l = e("nlpopup").data("expires"),
                ...
                d = function () {
                    ...
                    n <= 40 && (n = 40),
                    o.css("top", n),
                    e("#nlpopup, #nlpopup_overlay").fadeIn(500)
                };
            e(".nlpopup_close, #nlpopup_overlay").on("click", function (i) {
                ...
                e("#nlpopup, #nlpopup_overlay").fadeOut(200),
                i.preventDefault()
            }),
            "closed" != e.cookie("nlpopup") && setTimeout(d, r)
        }
        e("ul.jq-accordian > li:has( > ul ) > a").append(
            "<span class='jq-accordionIcon'></span>"
        ),
        ...
        c.on("click", function (i) {
            e(this).hasClass("is-active")
                ...
                : (u.not(this).removeClass("is-active"), e(this).addClass("is-active"))
        }),
        e(function () {
            ...
            e(".price-range-slider").slider({
                ...
                step: 10,
                slide: function (i, a) {
                    e("#price-range-from-to").html(
                        "Price : <span class='from'>$" + a.values[0] + "</span> &mdash; <span class='to" +
                        "'>$" + a.values[1]
                    ),
                    e("#price_range_min").val(a.values[0]),
                    e("#price_range_max").val(a.values[1])
                }
            }),
            e("#price-range-from-to").html(
                "Price : <span class='from'>$" + e(".price-range-slider").slider("values", 0) +
                "</span> &mdash; <span class='to'>$" + e(".price-range-slider").slider("values", 1) +
                "</span>"
            ),
        ...
        p.on("click", function (e) {
            e.preventDefault(),
            m.addClass("product-list-view"),
            p.addClass("product-view-icon-active"),
            v.removeClass("product-view-icon-active")
        }),
        v.on("click", function (e) {
            e.preventDefault(),
            m.removeClass("product-list-view"),
            p.removeClass("product-view-icon-active"),
            v.addClass("product-view-icon-active")
        })
    }),
    e(function () {
        ...
        e(".product-image-slider-thumbnails")
            .find("button")
            .hasClass("slick-arrow")
                ? (
                    e(".product-image-slider-thumbnails").css("padding-left", "30px"),
                    e(".product-image-slider-thumbnails").css("padding-right", "30px")
                )
                : (
                    e(".product-image-slider-thumbnails").css("margin-left", "-7px"),
                    e(".product-image-slider-thumbnails").css("margin-right", "-7px")
                )
    }),
    function () {
        var e,
        ...
        i(document).ready(function () {
            void 0 == i("#rev_slider_1078_1").revolution
                ? revslider_showDoubleJqueryError("#rev_slider_1078_1")
                : e = i("#rev_slider_1078_1")
                    .show()
                    .revolution({
                        sliderType: "standard",
...
window.success = function (msg) {
    var dom = '<div class="top-alert"><div class="arrow-up"></div><div class="alert alert-suc' +
            'cess alert-dismissible fade in " role="alert"><i class="glyphicon glyphicon-ok' +
            '"></i> ' + msg + '</div></div>';
    var jdom = $(dom);
    jdom.hide();
...
// $(document).on('click', '.product-item-inner a', function (event) {     var
// clickeID = Number
// (event.target.parentElement.parentElement.parentElement.parentElement.dataset.id);
...
$('.search--box button').on('click', function (e) {
    e.preventDefault();
    window.location = $('meta[name="root-site"]').attr('content') + '/category/' + $(
        '.search-query'
    ).val();
});
...
if (location.href === location.origin + "/" || location.href === location.origin + "/about" || location.href === location.origin + "/5/category" || location.href === location.origin + "/login" || location.href === location.origin + "/cart" || location.href === location.origin + "/product" || location.href === location.origin + "/checkout" || location.href === location.origin + "/register") {
    filter_mobileButton.style.display = "none";
}
var a = location.href;
var b = a.split("/");
var c = Number(b[3]);
if (isNaN(c) || typeof(c) === "undefined") {} else {
    var d = c;
}
...
function asd () {
        var e,
            i = jQuery;
        i(document).ready(function () {
            void 0 == i("#rev_slider_mobile").revolution
                ? revslider_showDoubleJqueryError("#rev_slider_mobile")
                : e = i("#rev_slider_mobile")
                    .show()
                    .revolution({
                        sliderType: "standard",
                        jsFileLocation: "../plugins/rev_slider/js/",
